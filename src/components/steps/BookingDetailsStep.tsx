...
export function BookingDetailsStep({
  ...
  return (
    <div className="space-y-6">
      <div className="glass rounded-2xl border border-amber-700/50 p-8">
        ...
        {/* Service Summary */}
        <div className="mb-8 rounded-lg border border-amber-600/50 bg-slate-700/20 p-4">
          <h4 className="mb-2 font-semibold text-white">{String(serviceName)}</h4>
          <p className="text-sm text-amber-400">{String(serviceDescription)}</p>
          {serviceDuration && (
        ...
        {/* Requirements */}
        <div className="rounded-lg border border-amber-600/50 bg-amber-700/10 p-4">
        ...
        {/* Summary */}
        <div className="mt-8 rounded-lg bg-linear-to-r from-cyan-500/10 to-amber-600/10 border border-amber-500/30 p-4">
      ...
      <button
        onClick={handleNext}
        className="w-full rounded-lg bg-linear-to-r from-cyan-500 to-amber-600 px-6 py-3 font-semibold text-white transition hover:shadow-lg hover:shadow-cyan-500/50"
      >
