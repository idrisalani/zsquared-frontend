        ...
        <div className="mb-12 text-center">
          <div className="flex justify-center mb-6">
            <div className="relative">
              <div className="absolute inset-0 bg-linear-to-r from-green-400 to-blue-400 rounded-full blur-lg opacity-75"></div>
          ...
          <div className="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg font-bold text-lg">
            Order #{orderNumber}
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="rounded-2xl border-2 border-gray-200 bg-white p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* Date */}
              <div className="pb-6 border-b md:border-b-0 border-gray-200">
                <p className="text-sm text-gray-600 font-semibold mb-2">Event Date</p>
              ...
              <div className="pb-6 border-b md:border-b-0 border-gray-200">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-sm text-gray-600 font-semibold">Number of Guests</p>
                </div>
            ...
            <div className="rounded-2xl border-2 border-gray-200 bg-white p-8">
              ...
              <div className="space-y-3">
                {selectedAddOns.map((addon) => (
                  <div key={addon.id} className="flex items-center justify-between p-3 bg-blue-50 rounded-lg border border-blue-200">
                    <p className="font-semibold text-gray-900">{addon.name}</p>
                    <p className="text-blue-600 font-bold">+${addon.price.toFixed(2)}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="rounded-2xl border-2 border-green-300 bg-green-50 p-8">
            ...
            <div className="space-y-3 mb-6">
              <div className="flex justify-between items-center pb-3 border-b border-green-200">
                <p className="text-gray-700">Base Service ({bookingState.selectedService?.name})</p>
                <p className="font-semibold text-gray-900">${baseServicePrice.toFixed(2)}</p>
              </div>

              {additionalHours > 0 && (
                <div className="flex justify-between items-center pb-3 border-b border-green-200">
                  <p className="text-gray-700">{additionalHours}h Additional Hour(s) @ $50/hr</p>
              ...
              {addOnsTotal > 0 && (
                <div className="flex justify-between items-center pb-3 border-b border-green-200">
                  <p className="text-gray-700">Selected Add-ons ({selectedAddOns.length})</p>
                  <p className="font-semibold text-gray-900">${addOnsTotal.toFixed(2)}</p>
                </div>
              )}
          ...
          <div className="rounded-2xl border-2 border-gray-200 bg-white p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-gray-900 break-all">{customerEmail}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg font-bold text-gray-900">{customerPhone}</p>
              </div>
          ...
          <div className="rounded-2xl border-2 border-blue-300 bg-blue-50 p-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-bold text-gray-900">Vendor Will Contact You</h3>
                  <p className="text-gray-600 mt-1">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="flex-1 flex items-center justify-center gap-2 px-6 py-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-bold">
              <Download size={20} />
              Download Booking Report
            </button>
            <Link
              to="/"
              className="flex-1 flex items-center justify-center gap-2 px-6 py-4 border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition font-bold"
            >
              🏠 Back to Home
            </Link>
          </div>
